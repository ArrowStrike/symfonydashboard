...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'cache_lite' => 'getCacheLiteService',
            ...
            'memcache_rep' => 'getMemcacheRepService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wt5CYczVxE', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JMRjEsGBEk', 0, 'bZM8uNtPUVvM8MXCGJKsVY', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /*
     * Gets the 'cache_lite' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DashboardBundle\Services\CacheLiteService A DashboardBundle\Services\CacheLiteService instance
     */
    protected function getCacheLiteService()
    {
        return $this->services['cache_lite'] = new \DashboardBundle\Services\CacheLiteService(array('lifeTime' => 3600, 'automaticSerialization' => true));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'dan', 'port' => NULL, 'dbname' => 'vtarasenkovs_symfony', 'user' => 'stasadm', 'password' => 'G0a4wa&', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/DashboardBundle/Entity')));
        ...
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'DashboardBundle' => 'DashboardBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1e2953ef5eda5b010e778ce60d26501d3c6241e4a0796ab771dd0ca40ae6ef5f');
    ...
    /*
     * Gets the 'memcache_rep' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DashboardBundle\Repository\MemcacheMessageRepository A DashboardBundle\Repository\MemcacheMessageRepository instance
     */
    protected function getMemcacheRepService()
    {
        return $this->services['memcache_rep'] = new \DashboardBundle\Repository\MemcacheMessageRepository($this->get('cache_lite'), $this->get('session'));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('ZEisTRdqqA', NULL, 'bZM8uNtPUVvM8MXCGJKsVY', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f3163fe67b9c707120e48fd385af65292d63bfcc');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1r-uTTbyMM', 0, 'bZM8uNtPUVvM8MXCGJKsVY', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TlGHpuihAR', 0, 'bZM8uNtPUVvM8MXCGJKsVY', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('592c312233aa75.08064224')), true);
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'DashboardBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/DashboardBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'dan',
            'database_port' => NULL,
            'database_name' => 'vtarasenkovs_symfony',
            'database_user' => 'stasadm',
            'database_password' => 'G0a4wa&',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'f3163fe67b9c707120e48fd385af65292d63bfcc',
            'locale' => 'en',
            'cache_options' => array(
                'lifeTime' => 3600,
            ...
            'kernel.secret' => 'f3163fe67b9c707120e48fd385af65292d63bfcc',
