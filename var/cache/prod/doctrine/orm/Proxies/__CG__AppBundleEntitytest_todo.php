 ...
 */
class test_todo extends \AppBundle\Entity\test_todo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\test_todo' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\test_todo' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\test_todo' . "\0" . 'category', '' . "\0" . 'AppBundle\\Entity\\test_todo' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\test_todo' . "\0" . 'priority', '' . "\0" . 'AppBundle\\Entity\\test_todo' . "\0" . 'dueDate', '' . "\0" . 'AppBundle\\Entity\\test_todo' . "\0" . 'createDate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (test_todo $proxy) {
